...
<body data-spy="scroll" data-target=".fixed-top">
        ...
        <div
            ...
            <div class="navbar-collapse offcanvas-collapse lg:flex lg:flex-grow lg:items-center"
                ...
                <ul class="pl-0 mt-3 mb-2 ml-auto flex flex-col list-none lg:mt-0 lg:mb-0 lg:flex-row">
                    ...
                    <div class="dropdown-divider"></div>-->
                            <a class="dropdown-item page-scroll active" href="privacy.html">سياسة الخصوصية</a>
                            <div class="dropdown-divider"></div>
    ...
    <div class="ex-basic-1 py-12">
        <div class="container mx-auto px-4 sm:px-8 xl:max-w-5xl xl:px-12">
            <h3 class="mt-12 mb-4">خصوصيتك محل اهتمامنا</h3>
            <p class="mb-12"> تسعى جهات إلى ضمان حماية معلومات المتدرب الشخصية، والحفاظ على خصوصيتها، والضمان بأن
                المعلومات الشخصية لا يتم استخدامها بطرق غير اخلاقية أو مشروعة، فهي ملتزمة بالشفافية فيما يتعلق بكيفية
                جمع واستخدام البيانات الشخصية بالمتدربين.</p>
            <div class="text-box mb-12">
                <h3 class="mb-2">المعلومات التي تطلب منك عند التسجيل للتدريب</h3> <br>
                <ul class="list-unstyled space-y-2 mb-4">
                    ...
                    <li class="flex">
                        <i class="fas fa-square"></i>
                        <div class="flex-1 ml-2">
                            <strong>المجال التدريبي الذي ترغب الالتحاق به</strong>
                        </div>
                    </li>
                    <li class="flex">
                        <i class="fas fa-square"></i>
                        <div class="flex-1 ml-2">
                            <strong>الخطة التدريبة المناسبة لك </strong>
                        </div>
                    </li>
                </ul>
            </div> <!-- end of text-box -->

            <h3 class="mb-4">مدة الاحتفاظ في بياناتك الشخصية ومع من نشاركها</h3>
            <p class="mb-12">نحتفظ في بيانات الشخصية فقط لفترة التدريب المتفق عليها، وتتم مشاركتها مع شؤون المتدربين
                لمتابعة تقدمك في الخطة التدريبية، ولسجلات الحضور والانصراف، واعتماد هذه البيانات في الوثائق الرسمية مثل
                الوثائق التابعة أو المطلوبة من المؤسسة التعليمية التي يتبع لها المتدرب او لخطابات الشكر.
            </p>

            <div class="text-box mb-12">
                <h3 class="mb-2">حقوقك لدى منصة جهات للتدريب</h3> <br>
                <p class="mb-4">متدربنا المميز، يحق لك تعديل المعلومات في حال تطلب الامر، بالإضافة الى هذا يحق لك أيضًا
                    الاستفسار اكثر عن سياسة الخصوصية لدينا، من خلال أيقونة <a href="contactus.html"
                        style="color: #2882C5;">تواصل معنا</a>.</p>
            </div>
            <!-- end of text-box -->
            <br>
            <p class="mb-12">من أجل ضمان أعلى معايير الأمان ولأجل حمايتك وحماية الآخرين؛ قد نطلب منك إثبات هويتك قبل
                البدء بالتدريب.
            </p>
        </div>
        <!-- end of container -->
