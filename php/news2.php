...
<body data-spy="scroll" data-target=".fixed-top">
    ...
    <header class="ex-header bg-gray">
        <div class="container px-4 sm:px-8 xl:px-4">
            <h1 class="xl:ml-24">تعاون جهات </h1>
        </div> <!-- end of container -->
    ...
    <ul class="breadcrumb">
        ...
        <li id="item_title_">تعاون جهات </li>
    </ul>
                        ...
                        <div class="row">
                            <div class="col-md-5">
                                <div class="left-image">
                                    <img src="images/جمعيات1.jpg" alt="" style="height: 400px; width: 400px;">
                                </div>
                            </div>
                            <div class="col-md-6 align-self-center">
                                <div class="container px-4 sm:px-8 xl:px-32">
                                    <p class="mb-4"> قامت منصة جهات بتنظيم عدة اجتماعات من خلال مكاتبها الإفتراضية عن
                                        بُعد تقديم خدماتها ومساعدة
                                        الجمعيات وسهولة التواصل لهم .
                                        <br>
                                        كما وتم تنظيم وجمع الأعضاء لكل جمعية، والتواصل مع الأعضاء المرشحين لحضور
                                        الاجتماع بمساعدة المشرفين
                                        والمدربين القائمين على تنظيم الوقت لحضور موعد الاجتماع، وشرح طريقة التصويت على
                                        البنود المطروحة لكل
                                        جمعية.
                                        <br>
                                        <mark>من هذه الجمعيات:</mark>
                                        الجمعية التعاونية متعددة الأغراض بالرهوة، والجمعية التعاونية للإسكان
                                        بالباحة، والجمعية البر
                                        الأهلية طبب ربيعة ورفيدة.
                                    </p>
                                    <p class="mb-12"> فقد تم نجاح اجتماع الجمعيات بحمد الله وتوفيقه، ونحن سُعداء لما
                                        حققه الجميع من خلال منصتنا.
                                    </p>
                                </div>
                            </div>
                        </div>
