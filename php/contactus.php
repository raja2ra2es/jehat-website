...
<body data-spy="scroll" data-target=".fixed-top">
                ...
                <ul class="pl-0 mt-3 mb-2 ml-auto flex flex-col list-none lg:mt-0 lg:mb-0 lg:flex-row">
                    ...
                    <li class="dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="dropdown01">
                            ...
                            <div class="dropdown-divider"></div>
                            <a class="dropdown-item page-scroll active" href="contactus.html">تواصل معنا</a>
                            <div class="dropdown-divider"></div>
    ...
    <header class="ex-header bg-gray">
        <div class="container mx-auto px-4 sm:px-8 xl:max-w-6xl xl:px-4">
            <h1 class="xl:ml-24">تواصل معنا</h1>
        </div> <!-- end of container -->
    ...
    <div class="row" style="padding-right: 35px;">
        <div class="col md-2">
            <div class="container" style="direction: ltr;">
                <div class="row">
                    <div class="col">
                        <p>نسعد في استقبال كافة استفساراتكم، حول البرامج أو المسارات، أو غيرها.</p>
                        &ensp;
                        <p>أملين أن نكون عند حسن ظنكم.</p>
                    </div>
                </div>
                <br><br>
                <div class="row">
                    <div class="col md-2">
                        <div class="input-field" style="min-height: 10vh;
                            display: flex;
                            align-items: right;
                            ...
                            <input type="text" required spellcheck="false" style="width: 100%;">
                            <label style="padding-right: 10px;"> البريد الإلكتروني</label>
                        </div>
                    </div>
                    <br>
                    <div class="col md-2">
                        <div class="input-field" style="min-height: 10vh;
                            ...
                            box-sizing: border-box;">
                            <input type="text" required spellcheck="false" style="width: 100%;">
                            <label style="padding-right: 10px;"> اسم المرسل</label>
                        </div>
                    </div>
                </div>
                <br>
                <div class="input-field" style="min-height: 10vh;
                    ...
                    box-sizing: border-box;">
                    <input type="text" required spellcheck="false" style="width: 100%;">
                    <label style="padding-right: 10px;"> عنوان الرسالة</label>
                </div>
                <br>
                <div class="input-field" style="min-height: 10vh;
                    display: flex;
                    ...
                    padding: 0;
                    box-sizing: border-box;">
                    <input type="text" required spellcheck="false" style="width: 100%; height: 150px;">
                    <label style="padding-right: 10px;"> نــص الــــرســـالـة</label>
                </div>
            </div>
            <br><br>
            <div class="container" style="align-items: center;">
                <div style="text-align:center">
                    ...
                    <a class="btn-solid-lg secondary" href="" style="text-align:center">إرسال</a>
                </div>
            </div>
        </div>
        <div class="col md-2">
            <div class="xl:ml-14">
                <img width="500" height="600" src="images/التواصل-01.png" style="width: 100%;">
            </div>
            <br><br><br>
        </div>
    </div>
