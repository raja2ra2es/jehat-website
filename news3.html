...
<body data-spy="scroll" data-target=".fixed-top">
    ...
    <header class="ex-header bg-gray">
        <div class="container px-4 sm:px-8 xl:px-4">
            <h1 class="xl:ml-24">انتهاء فترة التدريب</h1>
        </div> <!-- end of container -->
    ...
    <ul class="breadcrumb">
        ...
        <li id="item_title_">انتهاء فترة التدريب</li>
    </ul>
                        ...
                        <div class="row">
                            <div class="col-md-5">
                                <div class="left-image">
                                    <img src="images/1تخرج.jpg" alt="" style="height: 400px; width: 400px;">
                                </div>
                            </div>
                            <div class="col-md-6 align-self-center">
                                <div class="container px-4 sm:px-8 xl:px-32">
                                    <p class="mb-4">
                                        نفخر بتخريج مركز جهات للتدريب عدد من المتدربيين في عدة برامج تدريبية، وساعات
                                        متفق عليها تحت
                                        إدارة المشرفين والمدربين، مع تقييم التزامهم بجميع شؤون التدريب وتنفيذ المهام
                                        المسندة لهم وتقييمها من قبل
                                        المشرفين واكتسابهم الخبرة وتطوير ذاتهم.
                                        <br>
                                        حيث بلغ عدد المتدربين بعد انتهاء فترة تدريبهم لدى مركز جهات للتدريب -١١١- متدرب،
                                        كما قام مركز جهات
                                        بتقديم شهادة معتمدة لجميع المتدربيين الذين التحقوا بتلك البرامج تقديرًا وشكرًا
                                        لما قدموه من إنجاز.
                                        <br><br>
                                        سعدنا بحضورهم ورغبتهم الجادة في حب التعلم وتفاعلهم المميز من خلال أيام برامجهم
                                        التدريبية،
                                        ومن اللحظات الجميلة التي تمنحنا طاقة إيجابية لبذل المزيد تجاه المتدربين ردود
                                        الفعل التي تصلنا منهم عند
                                        انتهاء برامجهم التدريبية.
                                        ‏لحظات تعكس لنا مدى الأثر الذي تم تركه وبأن تدريبهم ومنحهم جزء من الوقت سيشكل
                                        جزء ثمين من رحلتهم العلمية
                                        والعملية ويستحق منا بذل كل ما بوسعنا لمساعدتهم، متمنين لهم مزيدًا من التفوق
                                        والنجاح.
                                    </p>
                                </div>
                            </div>
