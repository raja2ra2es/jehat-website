...
<body data-spy="scroll" data-target=".fixed-top">
    ...
    <header class="ex-header bg-gray">
        <div class="container px-4 sm:px-8 xl:px-4">
            <h1 class="xl:ml-24">مركز جهات للتدريب</h1>
        </div> <!-- end of container -->
    ...
    <ul class="breadcrumb">
        ...
        <li id="item_title_">مركز جهات للتدريب</li>
    </ul>
                        ...
                        <div class="row">
                            <div class="col-md-5">
                                <div class="left-image">
                                    <img src="images/انطلاقة-جهات.jpg" alt="" style="height: 450px; width: 400px;">
                                </div>
                            </div>
                            <div class="col-md-6 align-self-center">
                                <div class="container px-4 sm:px-8 xl:px-32">
                                    <p class="mb-4">
                                        تم افتتاح مركز جهات للتدريب في بداية هذا العام لتنمية وتطوير مهارات الكوادر
                                        الشابة في مختلف
                                        المجالات، حيث تم استقطاب متدربين حيث وصل عددهم لأكثر من مئة وخمسون متدرب من جميع
                                        الجنسيات، وجميع الأعمار
                                        على يد مدربين
                                        ومشرفين ذوو خبرة.
                                        <br><br>
                                        <mark> برامج وأقسام جهات للتدريب: </mark>
                                        <br>
                                        يتميز مركز جهات للتدريب ببرامجه المتنوعة، منها: تدريب ثلاثة أشهر، والتدريب
                                        التعاوني،
                                        وتمهير، والتدريب الصيفي، والتدريب بالساعات.
                                        <br>
                                        وأضافت عدة أقسام منها إدارة الموارد البشرية، والمحاماة،والبرمجة،والدعم التقني
                                        وغيرها من الأقسام.
                                        <br><br>
                                        <mark> برامج وأقسام جهات للتدريب: </mark>
                                        <br>

                                        كما وفرت المنصة للمتدربين عدة خدمات تخدم المتدرب منها: المكاتب الافتراضية ومنصة
                                        لرفع
                                        المعاملات ورفع الحضور والانصراف وتقديم شهادة معتمدة عند انتهاء التدريب لكل
                                        متدرب.
                                        <br><br>
                                        وبالأخير سائلين الله التوفيق لمركز جهات للتدريب، والشكر الجزيل على جهودهم
                                        متمنيين لهم دوام
                                        التوفيق والنجاح وتحقيق إنجازات أكثر وأكثر.
                                    </p>
                                </div>
                            </div>
                        </div>
